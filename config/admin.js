    ...
    const gplModsTheme = {
        ...
        overrides: {
            ...
            colors: {
                ...
                highlight: '#12151c', highlightHover: '#1a1e28',
            ...
            // ---------------------------------
            {
                ...
                options: {
                    ...
                    editProperties: [
                        ...
                        'requiresRoot', 'requiresDevMode', 'isTweakConvertible', 'requiresDependencies', 'requiresDisableAntivirus',
                    ...
                    properties: {
                        requiresRoot: { type: 'boolean', label: 'Requires Root', description: 'Android: App requires root access (Magisk, KernelSU, APatch).' },
                        requiresDevMode: { type: 'boolean', label: 'Requires Developer Mode', description: 'Android / Windows: Requires Developer Mode or USB debugging enabled.' },
                        isTweakConvertible: { type: 'boolean', label: 'Tweak is Convertible', description: 'iOS Jailbroken: Tweak is convertible between rootful and rootless (Derootifier, RootHide, Xina).' },
                        requiresDependencies: { type: 'boolean', label: 'Requires Dependencies', description: 'iOS Jailbroken: Tweak requires external dependencies/libraries to be installed first.' },
                        requiresDisableAntivirus: { type: 'boolean', label: 'Requires Disabling Antivirus', description: 'Windows: Requires disabling Windows Defender / Antivirus or adding an exclusion.' },
